#!/usr/bin/env python3
"""
Example demonstrating stacking multiple objects.
"""
...
def main():
    ...
    pygame.display.set_caption("Stacking Demo")
    ...
    # Create multiple dynamic circles for stacking
    for i in range(5):
        circle_shape = Circle(Vec2(-10 + i * 5, 10 + i * 5), 2)
